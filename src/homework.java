...
class Node_State
{
    ...
    Node_State(char board_state1[][],String move_type1, String move_pos1,int value1)
    {
        ...
        Node_State(char board_state1[][],String move_type1, String move_pos1,int value1,int alpha1,int beta1)
    {
        board_state = board_state1;
        move_type = move_type1;
        move_pos = move_pos1;
...
public class homework {
	...
	public static int new_board_size;
        public static ArrayList<Node_State> opened = new ArrayList<Node_State>();
        public static Node_State Solution_node;
	...
	public static int calculate_value(char board[][])
	{
        ...
        public static void printtofile(){   
            try {
                FileWriter ran = new FileWriter("output.txt",false);
                System.out.println("***");
	            ...
	            {	
	                if(curr_board[q][w]=='.')
	                {
	                    ...
	                    v=min_value(curr_board1,curr_depth+1);
                            ...
                            opened.add(new Node_State(curr_board1,"Stake",ipos,v));
	                }
	            }
	        }
	        for (int q=1;q<(board_size+1);q++)
	                ...
	                if(curr_board[q][w]=='.'){
	                    ...
	                    if ((curr_board1[q+1][w]== my_symbol) || (curr_board1[q-1][w]==my_symbol) || (curr_board1[q][w+1]== my_symbol) || (curr_board1[q][w-1]==my_symbol))
	                    {
	                        ...
	                        if(flag==1){
	                            v=min_value(curr_board1,curr_depth+1);
	                            String ipos=Integer.toString(q)+' '+Integer.toString(w);
                                    opened.add(new Node_State(curr_board1,"Raid",ipos,v));
	                        }
	                    }
	                }
	            }
	            ...
	            {	
	                if(curr_board[q][w]=='.')
	                {
	                    ...
	                    v1=min_beta_value(curr_board1,curr_depth+1,alpha,beta);
                            ...
                            String ipos=Integer.toString(q)+' '+Integer.toString(w);
                            opened.add(new Node_State(curr_board1,"Stake",ipos,v1,alpha,beta));
	                }
	            }
	        }
	        for (int q=1;q<(board_size+1);q++)
	                    ...
	                    if ((curr_board1[q+1][w]== my_symbol) || (curr_board1[q-1][w]==my_symbol) || (curr_board1[q][w+1]== my_symbol) || (curr_board1[q][w-1]==my_symbol))
	                    {
	                        ...
	                        if(flag==1){
	                            int v1;
                                    ...
                                    alpha = Math.max(alpha, v);
	                            String ipos=Integer.toString(q)+' '+Integer.toString(w);
                                    opened.add(new Node_State(curr_board1,"Raid",ipos,v1,alpha,beta));
	                        }
	                    }
	                }
	            }
